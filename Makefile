...
test: build data_files
	 @echo Test 1
	./${APP_NAME} -n 100 -out result_test1.txt | true
	@echo Test 2
	./${APP_NAME} -n 200 -out result_test2.txt | true
	@echo Test 3
	./${APP_NAME} -n 400 -out result_test3.txt | true
	@echo Test 4
	./${APP_NAME} -n 800 -out result_test4.txt | true
	@echo Test 5
	./${APP_NAME} -out result_test4.txt -n 100 | true
